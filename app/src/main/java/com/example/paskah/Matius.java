...
public class Matius extends AppCompatActivity {
    private String TAG = Matius.class.getSimpleName();
    ...
    private static String url = "https://api-alkitab.herokuapp.com/v2/passage/Mat/26?ver=tb";

    private static String url1 = "https://api-alkitab.herokuapp.com/v2/passage/Mat/27?ver=tb";

    private static String url2 = "https://api-alkitab.herokuapp.com/v2/passage/Mat/28?ver=tb";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matius);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Matius.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String getMat = getIntent().getStringExtra("MyMat");
                ...
                try {
                    switch (getMat){
                        ...
                        case "Yesus diadili":
                            ...
                            // looping through All Contacts
                            for (int i = 56; i < provinsis1.length(); i++) {
                        ...
                        case "Yesus dikubur":
                            ...
                            // looping through All Contacts
                            for (int i = 56; i < provinsis3.length(); i++) {
                            ...
                            break;
                        case "Penemuan Luar Biasa Wanita":
                        ...
                        case "Saksi-Saksi Palsu":
                            ...
                            break;
                        case "Amanat Tuhan yang Bangkit":
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    Matius.this, contactList,
                    R.layout.list_matius, new String[]{"content"}, new int[]{R.id.conten});
